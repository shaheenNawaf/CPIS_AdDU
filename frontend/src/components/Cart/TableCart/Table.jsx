            ...
            <table className= 'table-auto min-w-full bg-white rounded-b-3xl'>
                <thead className="">
                    <tr onClick= { Modal }>
                        ...
                        <th className={headerStyle}>Stock Type</th>
                ...
                <tbody>
                    <tr className={rowStyle} onClick={ Modal }>
                        ...
                        <td className={dataStyle}>Stock-Out</td>
                        <td className={dataStyle}>1</td>
                        <td className={dataStyle}>12/05/2024</td>
                        <td className={dataStyle}><Button buttonName="Remove Stock" buttonState="decline"/></td>
                    </tr>
                    <tr className={rowStyle} onClick={ Modal }>
                        <td className={dataStyle}>Oil</td>
                        <td className={dataStyle}>Stock-In</td>
